package aunth.validator;

import aunth.entity.User;
import aunth.service.UserService;
...
public class UserValidator implements Validator {
    ...
    public final Pattern patternPassword = Pattern.compile("^(?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\\s).{7,}$");
    public final Pattern patternName = Pattern.compile("[a-zA-Z][a-zA-Z0-9-_\\.]{3,}$");
    ...
    public void validate(Object o, Errors errors) {
        ...
        Matcher matcherName = patternName.matcher(user.getUsername());
